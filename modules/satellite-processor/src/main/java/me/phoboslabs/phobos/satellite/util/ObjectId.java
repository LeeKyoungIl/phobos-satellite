...
import static me.phoboslabs.phobos.satellite.util.Assertions.isTrueArgument;
import static me.phoboslabs.phobos.satellite.util.Assertions.notNull;
...
import me.phoboslabs.phobos.satellite.exception.ServerProcessException;
...
public final class ObjectId implements Comparable<ObjectId>, Serializable {
    ...
    static {
        try {
            ...
            throw new ServerProcessException(e.getMessage());
        }
    }
